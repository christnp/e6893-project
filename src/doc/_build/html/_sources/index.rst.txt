.. U.S. Grain Production Performance Heat Map documentation master file, created by
   sphinx-quickstart on Tue Nov 26 10:17:32 2019.
   You can adapt this file completely to your liking, but it should at least
   contain the root `toctree` directive.

Welcome to U.S. Grain Production Performance Heat Map's documentation!
======================================================================
...
.. image:: ../../work/data_visual_prelim.png
...
* List items can go on for several lines as long as you remember to keep the rest of the list item indented.
...
.. literalinclude:: ../usheatmap/CountryBoxes.py
    :lines: 9-11
    :emphasize-lines: 2
